<nav class="modulos">
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=funcoes&file=escobo">
                    Função & Escobo
                </a>
            </li>
            <li>
    ...
    <div class="modulo laranja">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=array&file=array_basico">
                    Array Basico
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=array&file=op_array">
                    Operações Com Array
                </a>
            </li>
            <li>
